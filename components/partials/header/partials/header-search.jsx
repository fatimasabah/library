...
function HeaderSearch () {
    ...
    return (
        <div className="header-search header-search-extended mr-0 header-search-visible d-none d-lg-block">
            ...
            <form action="#" method="get" onSubmit={ onSubmitSearchForm } onClick={ showSearchForm }>
                <div className="header-search-wrapper search-wrapper-wide">
                    ...
                    <input type="text" onChange={ onSearchChange } value={ searchTerm } className="form-control" name="q" placeholder="Search books reasorses ..." required />
